...
create table Compras_Produtos (cod_produtos int, id_compra int auto_increment, primary key (cod_produtos, id_compra), foreign key (cod_produtos) references Produtos(cod),
foreign key (id_compra) references Compras(id));

#Relacionamento N:N Saida
create table Saida_Produtos (cod_produtos int, id_saida int auto_increment, primary key (cod_produtos, id_saida), foreign key (cod_produtos) references Produtos(cod),
