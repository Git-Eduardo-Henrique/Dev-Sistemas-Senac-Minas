...
Text_Nome.grid(row=1, column=0)
nome_Entry.grid(row=1, column=1)
Text_Data.grid(row=2, column=0)
Data_Entry.grid(row=2, column=1)
Text_CPF.grid(row=3, column=0)
CPF_Entry.grid(row=3, column=1)
Text_Tele.grid(row=4, column=0)
Tele_Entry.grid(row=4, column=1)
...
frame_5.grid(row=2, column=0, sticky=NSEW)
