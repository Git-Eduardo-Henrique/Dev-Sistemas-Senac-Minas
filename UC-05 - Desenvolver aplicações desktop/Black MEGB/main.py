...
bt_add_bibli_sonic = Button(frame_sonic, text='Adicionar a Biblioteca', font='palatino 15 bold', bd=0, bg='#737373',
                            fg=black, activebackground='#737373', activeforeground=black,
                            command=lambda: back.add_biblioteca(bt_add_bibli_sonic, bt_sonic_bibli, x=5, y=192, email=en_email.get()))
...
bt_add_bibli_dk = Button(frame_donkeykong, text='Adicionar a Biblioteca', font='palatino 15 bold', bd=0, bg='#737373',
                         fg=black, activebackground='#737373', activeforeground=black,
                         command=lambda: back.add_biblioteca(bt_add_bibli_dk, bt_donkey_bibli, x=10, y=219, email=en_email.get()))
...
bt_add_bibli_mk = Button(frame_mk, text='Adicionar a Biblioteca', font='palatino 15 bold', bd=0, bg='#737373', fg=black,
                         ...
                         command=lambda: back.add_biblioteca(bt_add_bibli_mk, bt_mk3_bibli, x=0, y=244, email=en_email.get()))
...
bt_add_bibli_bomber = Button(frame_bomberman, text='Adicionar a Biblioteca', font='palatino 15 bold', bd=0,
                             ...
                             command=lambda: back.add_biblioteca(bt_add_bibli_bomber, bt_bomber, x=0, y=269, email=en_email.get()))
...
La_jogos = Label(frame_perfil, text='', font='palatino 15 bold', bd=0, bg=dark_gray, fg=white)
# Buttons
