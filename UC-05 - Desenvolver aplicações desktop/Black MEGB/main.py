...
bt_add_bibli = Button(frame_sonic, text='Adicionar a Biblioteca', font='palatino 15 bold', bd=0, bg='#737373', fg=black,
                      activebackground='#737373', activeforeground=black,
                      command=lambda: bt_sonic_bibli.place(width=195,
                                                           height=21,
                                                           x=5,
                                                           y=192))
bt_add_bibli.place(width=200, height=39, x=240, y=477)
...
bt_add_bibli = Button(frame_bomberman, text='Adicionar a Biblioteca', font='palatino 15 bold', bd=0, bg='#737373',
                      fg=black, activebackground='#737373', activeforeground=black, command=lambda:
    bt_bomber.place(width=195, height=21, x=0, y=269))
bt_add_bibli.place(width=200, height=39, x=240, y=477)
# =======================================================================================================================
# Frame Biblioteca
...
lb_perfil.pack()
# Label
La_N_exibicao = Label(frame_perfil, text=Lista_info[0], font='palatino 15 bold', bd=0, bg=dark_gray, fg=white)
La_Nome = Label(frame_perfil, text=Lista_info[2], font='palatino 15 bold', bd=0, bg=dark_gray, fg=white)
La_email = Label(frame_perfil, text=Lista_info[3], font='palatino 15 bold', bd=0, bg=dark_gray, fg=white)
