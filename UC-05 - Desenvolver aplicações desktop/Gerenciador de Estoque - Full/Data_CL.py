...
class Data:  # faz a conexão com o banco de dados e usa seus dados
    ...
    def cadastro_produto(self, nome, quant, fabri):  # faz o cadastro do produto no banco
        try:
    ...
    def cadastro_fabricante(self, nome):  # faz o cadastro do fabricante no banco
    ...
    def altera_produtos(self, cod, mudar, valor):  # altera o dado de descrição de um produto
