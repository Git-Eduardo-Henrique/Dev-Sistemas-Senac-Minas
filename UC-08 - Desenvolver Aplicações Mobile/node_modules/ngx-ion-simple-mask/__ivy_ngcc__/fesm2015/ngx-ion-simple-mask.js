...
SimpleMaskDirective.ɵfac = function SimpleMaskDirective_Factory(t) { return new (t || SimpleMaskDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Renderer2), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.NgControl, 2)); };
SimpleMaskDirective.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: SimpleMaskDirective, selectors: [["", "simpleMask", ""]], hostBindings: function SimpleMaskDirective_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("input", function SimpleMaskDirective_input_HostBindingHandler($event) { return ctx.onInput($event); })("blur", function SimpleMaskDirective_blur_HostBindingHandler($event) { return ctx.onBlur($event); })("ionBlur", function SimpleMaskDirective_ionBlur_HostBindingHandler($event) { return ctx.inputOnblur($event); });
    } }, inputs: { addPatterns: "addPatterns", newPatterns: "newPatterns", mask: ["simpleMask", "mask"], clearIfNotMatch: "clearIfNotMatch", fillWithExpected: "fillWithExpected" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
SimpleMaskDirective.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: SimpleMaskDirective, factory: SimpleMaskDirective.ɵfac });
/** @nocollapse */
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(SimpleMaskDirective, [{
        type: Directive,
        args: [{
                selector: '[simpleMask]'
            }]
        ...
        type: Injectable
    }], function () { return [{ type: ɵngcc0.Renderer2 }, { type: ɵngcc1.NgControl, decorators: [{
                type: Self
            }] }]; }, { 
    /**
     * @param {?} event
...
SimpleMaskPipe.ɵpipe = /*@__PURE__*/ ɵngcc0.ɵɵdefinePipe({ name: "simpleMask", type: SimpleMaskPipe, pure: true });
/** @nocollapse */
SimpleMaskPipe.ctorParameters = () => [];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(SimpleMaskPipe, [{
        type: Pipe,
        args: [{
                name: 'simpleMask'
            }]
...
SimpleMaskModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: SimpleMaskModule });
SimpleMaskModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({});
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(SimpleMaskModule, [{
        type: NgModule,
        args: [{
                declarations: [
                    SimpleMaskDirective,
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(SimpleMaskModule, { declarations: [SimpleMaskDirective, SimpleMaskPipe], exports: [SimpleMaskDirective, SimpleMaskPipe] }); })();
